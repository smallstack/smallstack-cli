...
module.exports = function (params) {
    ...
    if (config.isProjectEnvironment()) {
        ...
        // check if new generator is being used
        var datalayerPackageJSON = require(path.join(config.datalayerPath, "package.json"));
        if (!datalayerPackageJSON)
            throw new Error("No datalayer package.json found!");
        if (datalayerPackageJSON.smallstack && datalayerPackageJSON.smallstack.typesystem !== undefined)
            throw new Error("The datalayer of this project is being generated by the new smallstack-typesystem-generator!");
    }
