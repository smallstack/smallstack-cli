...
try {
    ...
    if (config.rootDirectory) {
        ...
        if (config.isProjectEnvironment()) {
            ...
            config.meteorSmallstackMeteorClientDirectory = path.join(config.meteorSmallstackDependenciesDirectory, "meteor-client");
            config.meteorSmallstackMeteorServerDirectory = path.join(config.meteorSmallstackDependenciesDirectory, "meteor-server");
            config.meteorSmallstackMeteorCommonDirectory = path.join(config.meteorSmallstackDependenciesDirectory, "meteor-common");
            config.meteorDatalayerPath = path.join(config.meteorSmallstackDependenciesDirectory, "datalayer");
